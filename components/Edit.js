    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TextInput style={{ marginTop: 20, height: 90, borderColor: 'gray', borderWidth: 1 }} placeholder="content" onChangeText={content => this.setState({ content })} value={this.state.content} multiline= {true} />
